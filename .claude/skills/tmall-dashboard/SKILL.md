...
**配色只有三样东西**：PLAUD 蓝（唯一交互色）、一条红色明度阶（轻度 → 严重，越深越重）、
中性灰。轻度别再改回黄色、中度别再改回橙色 —— 三个色相摆在一起像交通灯，既看不出轻重
顺序，页面也立刻变花。图表里的「非低价」是中性灰蓝（`--c-none`），它占柱子七八成，
调太浅整根柱子就看着是空的；非当期柱子的 `.dim` 也别低于 0.6，趋势图的重点恰恰是历史几期。
